  ...
  <div id="workerRank">
    <el-card :body-style="{ padding: '0px' }" style="min-height: 400px;padding-top: 20px;padding-bottom: 20px;">
      ...
      <transition-group v-bind:css="false"
                        ...
                        v-on:leave="leave"
                        name="fadeRank">
        <div v-if="show" v-for="(item, index) in rankDataList" :key="index" v-bind:data-index="index"
             style="text-align: center;margin: 10px;">
          <el-row style="width: 700px;margin: auto;">
            <el-col :span="2">
              <div class="centerR" style="height: 50px;float: right;">
                <span style="color: gray">{{index + 1}}</span>
              </div>
            </el-col>
            <el-col :span="3">
              <div class="centerR" style="height: 50px;">
                <img :src="getImgSrc(item.avatar)" width="44px" height="44px" style="border-radius: 6px;"/>
              </div>
            </el-col>
            <el-col :span="10">
              <div class="centerR" style="height: 50px;float: left;">

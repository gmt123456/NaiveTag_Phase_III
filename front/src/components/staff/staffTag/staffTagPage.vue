	...
	export default {
		...
		methods: {
			...
			tagPicReflash(picUrl) {
				this.$router.push({ name: 'staffTag', params: { taskId: localStorage.firstLevelTaskId, subTaskId: this.$route.params.subTaskId, taskType: this.$route.params.taskType, picUrl: picUrl}});
			},
